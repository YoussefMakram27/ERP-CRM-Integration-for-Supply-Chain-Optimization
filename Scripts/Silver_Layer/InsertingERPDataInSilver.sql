...
using (
    select supplier_id,
           ...
           case when try_cast(reliability_score as int) between 0 and 100
                then cast(reliability_score as int) else null end as reliability_score
